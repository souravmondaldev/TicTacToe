package io.github.souravmondaldev;
...
public class Game {
    ...
    public String checkWinningCondition(int countOfX, int countOfO, int gridSize, String output){
        if(countOfO == gridSize)
            output = "O Wins";
        else if(countOfX == gridSize)
            output = "X Wins";
        else if(countOfX == countOfO && countOfO + countOfX == gridSize * gridSize)
            output = "Tie";
        return output;
    }
    /**
    ...
    public String checkGameWinner(char [][]grid){
        ...
        for(int row  = 0; row < gridSize; row ++){
            ...
            if(countOfOBox == gridSize)
                return "O wins";
            else if(countOfXBox == gridSize)
                return "X wins";
        }
        for(int col  = 0; col < gridSize; col ++){
            countOfOBox = 0;
        ...
        countOfOBox = 0;
        countOfXBox = 0;
        for(int diag = 0; diag < gridSize; diag ++) {
            if (grid[diag][diag] == 'x')
                countOfXBox++;
            else if (grid[diag][diag] == 'o')
                countOfOBox++;
        }
        if(countOfOBox == gridSize)
            return "O wins";
        ...
        countOfXBox = 0;
        for(int diag = 0; diag < gridSize; diag ++){
            if (grid[diag][gridSize - diag - 1] == 'x')
                countOfXBox++;
            else if (grid[diag][gridSize - diag - 1] == 'o')
                countOfOBox++;
        }
        if(countOfOBox == gridSize)
            return "O wins";
        ...
        if(totalBoxChecked == gridSize * gridSize)
            result = "Tie";
        return result;
    }
